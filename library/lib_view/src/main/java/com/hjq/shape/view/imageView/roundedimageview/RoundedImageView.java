...
package com.hjq.shape.view.imageView.roundedimageview;
...
public class RoundedImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    private int mShape = RoundedDrawable.Shape.NORMAL;
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        float cornerRadiusOverride =
                a.getDimensionPixelSize(R.styleable.RoundedImageView_round_corner_radius, -1);

        mCornerRadii[Corner.TOP_LEFT] =
                a.getDimensionPixelSize(R.styleable.RoundedImageView_round_corner_radius_top_left, -1);
        mCornerRadii[Corner.TOP_RIGHT] =
                a.getDimensionPixelSize(R.styleable.RoundedImageView_round_corner_radius_top_right, -1);
        mCornerRadii[Corner.BOTTOM_RIGHT] =
                a.getDimensionPixelSize(R.styleable.RoundedImageView_round_corner_radius_bottom_right, -1);
        mCornerRadii[Corner.BOTTOM_LEFT] =
                a.getDimensionPixelSize(R.styleable.RoundedImageView_round_corner_radius_bottom_left, -1);
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.RoundedImageView_round_border_width, -1);
        if (mBorderWidth < 0) {
            mBorderWidth = DEFAULT_BORDER_WIDTH;
        }

        mBorderColor = a.getColorStateList(R.styleable.RoundedImageView_round_border_color);
        if (mBorderColor == null) {
            mBorderColor = ColorStateList.valueOf(RoundedDrawable.DEFAULT_BORDER_COLOR);
        }

        mMutateBackground = a.getBoolean(R.styleable.RoundedImageView_round_mutate_background, false);
        mShape = a.getInt(R.styleable.RoundedImageView_round_img_shape, RoundedDrawable.Shape.NORMAL);

        final int tileMode = a.getInt(R.styleable.RoundedImageView_round_tile_mode, TILE_MODE_UNDEFINED);
        ...
        final int tileModeX =
                a.getInt(R.styleable.RoundedImageView_round_tile_mode_x, TILE_MODE_UNDEFINED);
        if (tileModeX != TILE_MODE_UNDEFINED) {
            setTileModeX(parseTileMode(tileModeX));
        }

        final int tileModeY =
                a.getInt(R.styleable.RoundedImageView_round_tile_mode_y, TILE_MODE_UNDEFINED);
     ...
     *
     * @param shape if this {@link RoundedImageView} should be oval.
     */
    public void setOval(int shape) {
        mShape = shape;
        updateDrawableAttrs();
        updateBackgroundDrawableAttrs(false);
        invalidate();
