 ...
 */
public final class RatioConstraintLayout extends ShapeConstraintLayout {
    ...
    public RatioConstraintLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.RatioConstraintLayout);
        String sizeRatio = array.getString(R.styleable.RatioConstraintLayout_sizeRatio);
