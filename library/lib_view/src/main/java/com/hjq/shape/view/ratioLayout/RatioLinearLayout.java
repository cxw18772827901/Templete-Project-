 ...
 */
public final class RatioLinearLayout extends ShapeLinearLayout {
    ...
    public RatioLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.RatioLinearLayout);
        String sizeRatio = array.getString(R.styleable.RatioLinearLayout_sizeRatio);
