package com.hjq.shape.view.textview;
...
public final class SettingBar extends FrameLayout {
    ...
    public SettingBar(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mLeftView.setLineSpacing(getResources().getDimension(R.dimen.x15), mLeftView.getLineSpacingMultiplier());
        mRightView.setLineSpacing(getResources().getDimension(R.dimen.x15), mRightView.getLineSpacingMultiplier());

        mLeftView.setPaddingRelative((int) getResources().getDimension(R.dimen.x45),
                (int) getResources().getDimension(R.dimen.x36),
                (int) getResources().getDimension(R.dimen.x45),
                (int) getResources().getDimension(R.dimen.x36));
        mRightView.setPaddingRelative((int) getResources().getDimension(R.dimen.x45),
                (int) getResources().getDimension(R.dimen.x36),
                (int) getResources().getDimension(R.dimen.x45),
                (int) getResources().getDimension(R.dimen.x36));
        ...
        // 文字大小设置
        setLeftTextSize(TypedValue.COMPLEX_UNIT_PX, array.getDimensionPixelSize(R.styleable.SettingBar_bar_leftTextSize, (int) getResources().getDimension(R.dimen.x45)));
        setRightTextSize(TypedValue.COMPLEX_UNIT_PX, array.getDimensionPixelSize(R.styleable.SettingBar_bar_rightTextSize, (int) getResources().getDimension(R.dimen.x42)));
