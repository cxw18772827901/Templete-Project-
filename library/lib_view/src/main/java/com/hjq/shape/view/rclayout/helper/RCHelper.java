...
package com.hjq.shape.view.rclayout.helper;
...
public class RCHelper {
    ...
    public void initAttrs(Context context, AttributeSet attrs) {
        ...
        mStrokeColorStateList = ta.getColorStateList(R.styleable.RCAttrs_round_stroke_color);
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.RCAttrs_round_stroke_width, 0);
        mClipBackground = ta.getBoolean(R.styleable.RCAttrs_round_clip_background, false);
