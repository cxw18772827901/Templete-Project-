 ...
 */
public final class RatioRelativeLayout extends ShapeRelativeLayout {
    ...
    public RatioRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.RatioRelativeLayout);
        String sizeRatio = array.getString(R.styleable.RatioRelativeLayout_sizeRatio);
