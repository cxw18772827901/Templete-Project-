 ...
 * time   : 2019/08/23
 * desc   : 按照比例显示的 TextView
 */
public final class RatioTextView extends ShapeTextView {
    ...
    public RatioTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.RatioTextView);
        String sizeRatio = array.getString(R.styleable.RatioTextView_sizeRatio);
