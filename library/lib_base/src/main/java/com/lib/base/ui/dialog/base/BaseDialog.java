...
import com.lib.base.ui.action.DialogClickAction;
import com.lib.base.ui.action.HandlerAction;
import com.lib.base.ui.action.KeyboardAction;
import com.lib.base.ui.action.ResourcesAction;
...
public class BaseDialog extends AppCompatDialog implements LifecycleOwner,
    ...
    public static class Builder<B extends Builder<?>> implements
            ActivityAction, ResourcesAction, DialogClickAction, KeyboardAction {
