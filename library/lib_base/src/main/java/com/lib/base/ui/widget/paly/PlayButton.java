package com.lib.base.ui.widget.paly;
...
public final class PlayButton extends View {
    ...
    public PlayButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        int lineSize = typedArray.getInteger(R.styleable.PlayButton_pb_lineSize, (int) getResources().getDimension(R.dimen.x10));
    ...
    protected void onSizeChanged(int width, int height, int oldWidth, int oldHeight) {
        ...
        mWidth = width * 9 / 10;
        mHeight = height * 9 / 10;
        mCircleRadius = mWidth / (int) getResources().getDimension(R.dimen.x10);
        mCenterX = width / 2;
        mCenterY = height / 2;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        switch (MeasureSpec.getMode(widthMeasureSpec)) {
            ...
            case MeasureSpec.UNSPECIFIED:
                widthMeasureSpec = MeasureSpec.makeMeasureSpec((int) getResources().getDimension(R.dimen.x100), MeasureSpec.EXACTLY);
                break;
        ...
        switch (MeasureSpec.getMode(heightMeasureSpec)) {
            case MeasureSpec.AT_MOST:
            case MeasureSpec.UNSPECIFIED:
                heightMeasureSpec = MeasureSpec.makeMeasureSpec((int) getResources().getDimension(R.dimen.x100), MeasureSpec.EXACTLY);
                break;
            case MeasureSpec.EXACTLY:
            default:
                break;
