...
import com.lib.base.ui.dialog.base.InputDialog;
import com.lib.base.ui.dialog.base.MenuDialog;
import com.lib.base.ui.dialog.base.MessageDialog;
import com.lib.base.ui.dialog.base.PayPasswordDialog;
import com.lib.base.ui.dialog.base.SafeDialog;
import com.lib.base.ui.dialog.base.SelectDialog;
import com.lib.base.ui.dialog.base.ShareDialog;
import com.lib.base.ui.dialog.base.TimeDialog;
import com.lib.base.ui.dialog.base.TipsDialog;
import com.lib.base.ui.dialog.base.UpdateDialog;
...
public final class DialogActivity extends BaseActivity<DialogActivityBinding> {
    ...
    @Override
    public DialogActivityBinding viewBinding() {
        return DialogActivityBinding.inflate(getLayoutInflater());
    }
    ...
    public void initView() {
        setOnClickListener(this, R.id.btn_dialog_message, R.id.btn_dialog_input,
    ...
    public void onClick(View view) {
        ...
        if (viewId == R.id.btn_dialog_message) {
            ...
            if (!mWaitDialog.isShowing()) {
                mWaitDialog.show();
                GlobalThreadPoolUtil.postOnUiThreadDelay(mWaitDialog::dismiss, 2000);
            }
            ...
            new DateDialog.Builder(this)
                    ...
                    .setListener(new DateDialog.OnListener() {
                        ...
                        public void onSelected(BaseDialog dialog, int year, int month, int day) {
                            toasts(year + getString(R.string.common_year) + month + getString(R.string.common_month) + day + getString(R.string.common_day));
                            ...
                            toasts("时间戳：" + calendar.getTimeInMillis());
            ...
            new TimeDialog.Builder(this)
                    ...
                    .setListener(new TimeDialog.OnListener() {
                        ...
                        public void onSelected(BaseDialog dialog, int hour, int minute, int second) {
                            toasts(hour + getString(R.string.common_hour) + minute + getString(R.string.common_minute) + second + getString(R.string.common_second));
            ...
            toasts("记得改好第三方 AppID 和 Secret，否则会调不起来哦");

//            UMWeb content = new UMWeb("https://github.com/getActivitys/AndroidProject");
...
//                    })
            ...
            new BaseDialog.Builder<>(this)
                    ...
                    .setOnCreateListener(dialog -> toasts("Dialog 创建了"))
                    .addOnShowListener(dialog -> toasts("Dialog 显示了"))
                    .addOnCancelListener(dialog -> toasts("Dialog 取消了"))
                    .addOnDismissListener(dialog -> toasts("Dialog 销毁了"))
                    .setOnKeyListener((dialog, event) -> {
                        toasts("按键代码：" + event.getKeyCode());
                        return false;
                    })
                    .show();
