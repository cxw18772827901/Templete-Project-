package com.module.login.config;
...
public class ModuleLoginApp extends App {
    private static ModuleLoginApp moduleBApp;
     ...
     * @return ModuleAApp
     */
    public static ModuleLoginApp getModuleBApp() {
        return moduleBApp;
    }
